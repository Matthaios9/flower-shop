                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-custom">
                        <div class="single-footer-widget m-0">
                            ...
                            <p class="desc-content">DucAnh FLower Shop - Nơi những vẻ đẹp được bộc lộ qua từng sắc màu.</p>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-custom">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                <address>97 Man Thien Street, Thu Duc City,<br> Ho Chi Minh City.<br>Phone: 057 1405 128<br>Email: ducanhflowershop2022@gmail.com</address>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 text-center col-custom">
                        <div class="copyright-content">
                            <p>Copyright © 2021 <a href="ducanhflowershop2022@gmail.com" title="ducanhflowershop2022@gmail.com">DucAnh FLOWER SHOP</a> | Built with&nbsp;<strong>Flower Shop</strong>&nbsp;by <a href="ducanhflowershop2022@gmail.com" title="ducanhflowershop2022@gmail.com">DucAnh Group</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
