...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <c:url value="admin/report/transaction.htm?fromDate=${fromDate}&toDate=${toDate}" var="pagedLink">
            ...
            <div class="card-box">
                    ...
                    <form class="d-inline-flex mb-5" style="float:right">
                        <div class="row">
                            <div class="col-sm-5 col-md-5">
                                <div class="row">
                                    <label class="col-sm-4 col-md-4 col-form-label">From date</label>
                            ...
                            <div class="col-sm-5 col-md-5">
                                <div class="row">
                                    <label class="col-sm-5 col-md-5 col-form-label">To date</label>
                ...
                <div class="pb-20">
                    <table class="data-table table stripe hover nowrap" id="myTable">
                        ...
                        <c:forEach var="item" items="${pagedListHolder.pageList}" varStatus="row">
                            <tr>
                                ...
                                <td><fmt:formatDate value="${item.doneDate}" pattern="dd-MM-yyyy HH:mm:ss" /></td>
                    ...
                    <div class="mr-4 mb-4" style="float: right;">
                        <span>Total: <fmt:formatNumber pattern="###,### VND"  value="${totalAmount}" type="currency" /></span>
                    </div>
