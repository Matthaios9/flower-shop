                                                    ...
                                                    <tbody>
                                                      <c:forEach var="trans" items="${Trans}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <c:if test="${trans.status == 3}"><c:out value = "Finished"/></c:if>
                                                                <c:if test="${trans.status == 1 || trans.status == 4}" >
                                                                    <c:out value = "Not approved"/>
                                                                </c:if>
                                                                <c:if test="${trans.status == 2 || trans.status == 5}" >
                                                                    <c:out value = "Approved"/>
                                                                </c:if>
                                                                <c:if test="${trans.status == 6}" >
