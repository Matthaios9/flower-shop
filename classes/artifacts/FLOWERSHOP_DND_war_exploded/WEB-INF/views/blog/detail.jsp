                        ...
                        <div class="blog-post-details">
                            ...
                            <section class="blog-post-wrapper product-summery">
                                <div class="section-content section-title">
                                    <h2 class="section-title-2 mb-3">DucAnh Flower Shop Blog</h2>
                                    ...
                                    <blockquote class="blockquote mb-4">
                                        <p>Shop Hoa DucAnh sẽ là cầu nối để kết nối những tình cảm thân yêu của bạn, làm vững bền mối thâm giao bằng hữu tạo dựng đẳng cấp và phong cách khác biệt trong cuộc sống và công việc hay để chia ngọt sẻ bùi, gửi gắm tâm tư ...</p>
                                    </blockquote>
                                    ...
                                    <div class="comments-view-area">
                                        ...
                                        <div class="single-comment-wrap mb-4 comment-reply d-flex">
                                            ...
                                            <div class="comments-info">
                                                ...
                                                <div class="comment-footer d-flex justify-content-between">
                                                    <a href="#" class="author"><strong>Admin</strong> - July 30, 2022</a> <a href="#" class="btn-reply"><i class="fa fa-reply"></i> Reply</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="single-comment-wrap mb-4 d-flex">
                                            ...
                                            <div class="comments-info">
                                                ...
                                                <div class="comment-footer d-flex justify-content-between">
                                                    <a href="#" class="author"><strong>Minh</strong> - July 30, 2022</a>
                                                    <a href="#" class="btn-reply"><i class="fa fa-reply"></i> Reply</a>
                                                </div>
                                            </div>
                                        </div>
