                ...
                <div class="row">
                    <div class="col-lg-8 ml-auto mr-auto">
                        <div class="history-area-content text-center border-0">
                            <p><strong>DucAnh Flower Shop: From Student of PTITHCM</strong></p>
							...
							Shop Hoa DucAnh sẽ là cầu nối để kết nối những tình cảm thân yêu của bạn, làm vững bền mối thâm giao bằng hữu tạo dựng đẳng cấp và phong cách khác biệt trong cuộc sống và công việc hay để chia ngọt sẻ bùi, gửi gắm tâm tư ...
            ...
            <div class="row">
                <div class="col-lg-12 col-custom">
                    <div class="section-title text-center">
                        ...
                        <h2 class="section-title-2">DucAnh Flower Shop</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid-item">
                        <div class="ht-team-member">
                            ...
                            <div class="team-info text-center">
                                <h5 class="name">DucAnh </h5>
                                <div class="position">FlowerShop</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-custom">
                    <div class="grid-item">
                        <div class="ht-team-member">
                            ...
                            <div class="team-info text-center">
                                <h5 class="name">Trần Anh Đức </h5>
                ...
                <div class="col-lg-4 col-md-4 col-custom">
                    <div class="grid-item">
                        <div class="ht-team-member">
                            ...
                            <div class="team-info text-center">
                                <h5 class="name">D18CQIS01-N </h5>
                                <div class="position">PTITHCM</div>
                            </div>
                        </div>
                    </div>
                </div>
